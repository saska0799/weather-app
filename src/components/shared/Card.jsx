...
const Card = () => {
  ...
  return (
    <article className="flex md:w-[80%] justify-center items-center bg-slate-200 rounded-xl px-10 md:py-0 py-10 drop-shadow-lg">
      <img
      ...
      <div className="text-slate-800 flex flex-col justify-center items-center">
        <p className="text-6xl">{state.currentWeatherData.temp}°</p>
